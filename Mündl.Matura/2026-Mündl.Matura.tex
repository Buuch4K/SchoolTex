...
\begin{aufgabe}
	\begin{minipage}{0.5\linewidth}
		...
		\begin{parts}
			...
			\bl Fläche zw $-2$ und $0$ ist positiv\\ Fläche zw $0$ und $2$ ist negativ \\ $\Rightarrow$ Resultat wird negativ sein \el
		\end{parts}
	\end{minipage}
	\hfill
	\begin{minipage}{0.475\linewidth}
	...
	\begin{parts}
		...
		\bl $m=$ Steigung $\Rightarrow$ Ableitung am Punkt $P$\\ $q=$ $y-$Achsenabschnitt, wird mit Einsetzen des Punktes $P$ ermittelt.
