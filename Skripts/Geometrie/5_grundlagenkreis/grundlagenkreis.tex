...
\subsection{Kreisumfang}
	...
	\end{aufgabe}
	\begin{figure}[ht]
		\centering\includegraphics[scale=0.25]{6-12EckArchimedes.png}
	...
	\begin{aufgabe}
		Versuche nun den Iterationsweg von Archimedes mit Hilfe deines Taschenrechners nachzuvollziehen. Es soll der Umfang eines Kreises mit Durchmesser $d=1$ angenähert werden. Dabei starten wir mit dem inneren $6$-Eck mit Seitenlänge $s=0.5$, also dem Umfang $U_6=3$. Benutze die Formel \ref{eq:iterArchi}, um die Tabelle unten zu vervollständigen.
		\begin{table}[H]
			\centering
...
\subsection*{Fun Facts: (Stand $2023$)}
	\begin{itemize}
		...
		\begin{figure}[ht]
			\begin{minipage}{0.3\linewidth}
				\centering\includegraphics[scale=0.7]{pi4_1.png}
			\end{minipage}
			\hfill
			\begin{minipage}{0.3\linewidth}
				\centering\includegraphics[scale=0.8]{pi4_2.png}
			\end{minipage}
			\hfill
			\begin{minipage}{0.3\linewidth}
				\centering\includegraphics[scale=0.7]{pi4_3.png}
			\end{minipage}
	...
	\begin{aufgabe}
		...
		\begin{enumerate}[label=\alph*)]
			...
			\item \begin{minipage}{0.6\linewidth}
				Denke dir eine Schnur um den Aquator gelegt. Diese Schnur ist nun $10$ Meter zu lang, Um sie zu spannen, müsste man sie überalletwas von der Erde abstehen lassen. Wie gross muss der Abstand zur Erdoberfläche sein? Schätze zuerst!
			\end{minipage}
			\hfill
			\begin{minipage}{0.35\linewidth}
				\begin{figure}[H]
					\centering\includegraphics[scale=0.5]{ErdeMitSchnur.png}
				\end{figure}
			\end{minipage}
			\karos{4}
		\end{enumerate}
	...
	\begin{aufgabe}
		...
		\begin{figure}[H]
			\centering\includegraphics[scale=0.6]{AufgUmfang.png}
		\end{figure}
	\end{aufgabe}
...
\subsection{Kreisfläche}
	...
	\begin{aufgabe}
		Betrachte das Geogebra-Applet unter folgenden Link \url{https://www.geogebra.org/m/gpcvcgxc}.
		\begin{enumerate}[label=\alph*)]
	...
	\begin{aufgabe}
		...
		\begin{figure}[H]
			\centering\includegraphics[scale=0.6]{AufgFläche.png}
		\end{figure}
	\end{aufgabe}
...
\subsection{Kreisbogen und Kreissektor}
	...
	\begin{aufgabe}
		Bearbeite das Geogebra-Applet unter folgendem Link \url{https://www.geogebra.org/m/pyvvjumu} und notiere deine Überlegungen.\vspace{5pt}\newline
		\karos{4}
	\end{aufgabe}
	...
	\begin{satz}[Bogenlänge]
		...
		\hfill
		\begin{minipage}{0.3\linewidth}
			\centering\includegraphics[scale=0.5]{Kreisbogen.png}
		\end{minipage}
...
\section{Das Bogenmass}
	...
	\begin{definition}
		...
		\begin{minipage}{0.4\linewidth}
			\begin{figure}[H]
				\centering\includegraphics[scale=0.29]{Einheitskreis.png}
			\end{figure}
		\end{minipage}
	\end{definition}
	\begin{aufgabe}
		\begin{enumerate}
			...
			\begin{table}[H]
				...
				\end{tabular}
			\end{table}
			\item Überprüfe deine Berechnungen aus der Tabelle, indem du im Geogebra-Applet \url{https://www.geogebra.org/m/wwh8jhtm} den roten Punkt auf dem Kreis verschiebst.
		\end{enumerate}
		\karos{4}
	\end{aufgabe}
	...
	\begin{satz}
		...
		\begin{minipage}{0.4\linewidth}
			\begin{figure}[H]
				\centering\includegraphics[scale=0.45]{UmrechnungGradRad.jpeg}
			\end{figure}
		\end{minipage}
	\end{satz}
	\begin{aufgabe}
