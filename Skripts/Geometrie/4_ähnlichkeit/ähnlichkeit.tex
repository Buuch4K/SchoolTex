...
\begin{aufgabe}
	...
	\begin{minipage}{0.37\linewidth}
		\centering\includegraphics[scale=0.5]{einstiegstrahlensatz.png}
	\end{minipage}
	\karos{3}
\end{aufgabe}
...
\begin{satz}[Erster Strahlensatz]
	...
	\hfill
	\begin{minipage}{0.37\linewidth}
		\centering\includegraphics[scale=0.3]{ersterstrahlenssatz.png}
	\end{minipage}
\end{satz}
...
\begin{beispiel}
	...
	\begin{minipage}{0.57\linewidth}
		\begin{enumerate}[label=\alph*)]
			\item Gegeben sind folgende Strecken: $a=2$cm, $b=4$cm und $c=3$cm. Berechne die fehlende Strecke $d$.\vspace{2.5cm}
			\item Gegeben sind folgende Strecken: $b=9$cm, $c+d=17$cm und $d=8$cm. Berechne die fehlenden Strecken $a$ und $c$.\vspace{2.5cm}
		\end{enumerate}
	\end{minipage}
	\hfill
	\begin{minipage}{0.37\linewidth}
		\centering\includegraphics[scale=0.3]{strahlensatzfigur.png}
	\end{minipage}
\end{beispiel}
...
\begin{satz}[Zweiter Strahlensatz]
	...
	\hfill
	\begin{minipage}{0.37\linewidth}
		\centering\includegraphics[scale=0.34]{zweiterstrahlensatz.png}
	\end{minipage}
\end{satz}
...
\begin{beispiel}
	...
	\begin{minipage}{0.57\linewidth}
		\begin{enumerate}[label=\alph*)]
			\item Gegeben sind folgende Strecken: $a=2$cm, $b=4$cm und $f=7$cm. Berechne die fehlende Strecke $e$.\vspace{2.5cm}
			\item Gegeben ist zusätzlich die Strecke $c+d=17$cm. Berechne die fehlenden Strecken $c$ und $d$.\vspace{2.5cm}
		\end{enumerate}
	\end{minipage}
	\hfill
	\begin{minipage}{0.37\linewidth}
...
\begin{aufgabe}
	\begin{enumerate}
		...
		\begin{figure}[H]
			\hspace{1.5cm}\includegraphics[scale=0.5]{aufgtrapez.png}
		\end{figure}
	\end{enumerate}
\end{aufgabe}
...
\begin{aufgabe}
	\begin{enumerate}
		...
		\begin{figure}[H]
			\hspace{1.5cm}\includegraphics[scale=0.5]{aufgähnlichkeit.png}
		\end{figure}
	\end{enumerate}
\end{aufgabe}
