...
\section{Der Weg zum bestimmten Integral}
	\begin{wrapfigure}{r}{0.4\textwidth}
		\center{\includegraphics[width=0.3\textwidth]{images/x2_ausgang.png}}
	\end{wrapfigure}
	...
	\begin{minipage}{0.8\linewidth}
		\textbf{Untersumme:}
		\center{\includegraphics[width=0.7\textwidth]{images/x2_USumme4.png}}\newline
	...
	\begin{minipage}{0.8\linewidth}
		\textbf{Obersumme:}
		\center{\includegraphics[width=0.7\textwidth]{images/x2_OSumme4.png}}\newline
	...
	\begin{minipage}{0.8\linewidth}
		\center{\includegraphics[width=0.7\textwidth]{images/x2_USumme8.png}}\newline
	...
	\hfill
	\begin{minipage}{0.8\linewidth}
		\center{\includegraphics[width=0.7\textwidth]{images/x2_OSumme8.png}}\newline
		Die Höhe der Rechtecke ist also:
		\begin{enumerate}[label=\ ]\begin{multicols}{2}
				\item $f(\frac{1}{4})=\frac{1}{16}$
				\item $f(\frac{1}{2})=\frac{1}{4}$
	...
	\begin{aufgabe}
		...
		\begin{minipage}{0.55\linewidth}
			\begin{enumerate}[label=\alph*)]
				...
				\item Benutze das folgende Geogebra-Applet \url{https://www.geogebra.org/m/vzjzrfdj}, um deine Berechnungen zu überprüfen.
			\end{enumerate}
		\end{minipage}
		\hfill
		\begin{minipage}{0.4\linewidth}
			\centering\includegraphics[scale=0.25]{images/aufg_OberUnter.png}
		\end{minipage}
	\end{aufgabe}
...
\section{Der Hauptsatz der Differential und Integralrechnung}
	...
	\begin{beweis}
		\begin{wrapfigure}{r}{0.4\textwidth}
			\center{\includegraphics[width=0.3\textwidth]{images/flächenfunktion.png}}
		\end{wrapfigure}
	...
	\begin{aufgabe}
		...
		\begin{table}[H]
			...
			\begin{tabular}{p{7cm} c}
				\includegraphics[scale=0.3]{images/flächePosNeg1.png} & \includegraphics[scale=0.3]{images/flächePosNeg2.png} \\
				\includegraphics[scale=0.3]{images/flächePosNeg3.png} & \includegraphics[scale=0.3]{images/flächePosNeg4.png}
			\end{tabular}
		\end{table}
		\begin{enumerate}[label=\alph*)]
...
\subsection{Fläche zwischen zwei Graphen}
	...
	\begin{aufgabe}
		Betrachte die Funktionen $f(x)=-x^2+3x+3$ und $g(x)=x^2-4x+6$ im folgenden \href{https://www.geogebra.org/m/gfdvryzw}{Geogebra-Applet}.
		\begin{enumerate}[label=\alph*)]
...
\subsection{Volumen eines Rotationskörpers}
	...
	\begin{aufgabe}[für die Schnellen]
		...
		\begin{minipage}{0.35\linewidth}
			\begin{figure}[H]
				\centering\includegraphics[scale=0.5]{images/keplerfass.jpeg}
			\end{figure}
		\end{minipage}
	\end{aufgabe}\newpage
	\begin{beispiel}
