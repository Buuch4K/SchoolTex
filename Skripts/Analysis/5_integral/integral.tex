...
\section{Der Weg zum bestimmten Integral}
	\begin{wrapfigure}{r}{0.4\textwidth}
		\center{\includegraphics[width=0.3\textwidth]{x2_ausgang.png}}
	\end{wrapfigure}
	...
	\begin{minipage}{0.8\linewidth}
		\textbf{Untersumme:}
		\center{\includegraphics[width=0.7\textwidth]{x2_USumme4.png}}\newline
	...
	\begin{minipage}{0.8\linewidth}
		\textbf{Obersumme:}
		\center{\includegraphics[width=0.7\textwidth]{x2_OSumme4.png}}\newline
	...
	\begin{minipage}{0.8\linewidth}
		\center{\includegraphics[width=0.7\textwidth]{x2_USumme8.png}}\newline
	...
	\hfill
	\begin{minipage}{0.8\linewidth}
		\center{\includegraphics[width=0.7\textwidth]{x2_OSumme8.png}}\newline
		Die Höhe der Rechtecke ist also:
		\begin{enumerate}[label=\ ]\begin{multicols}{2}
				\item $f(\frac{1}{4})=\frac{1}{16}$
				\item $f(\frac{1}{2})=\frac{1}{4}$
	...
	\begin{enumerate}[label=\Alph*)]
		\item Spezialfall $a=b$:\newline Falls die beiden Grenze zusammenfallen, so ist die Breite der Rechtecke $\gap{2}$ und damit sind sowohl die Ober- als auch die Untersumme ebenfalls gleich $0$. Das heisst: \[\gap{5}.\]
		\item Spezialfall $a>b$:\newline Falls $a$ grösser ist als $b$, so gilt für die Breite der Rechtecke $\gap{2}$ und damit ändert sich auch das Vorzeichen des Integrals \[\gap{5}.\]
	\end{enumerate}
	\begin{satz}
...
\section{Der Hauptsatz der Differential und Integralrechnung}
	...
	\begin{beweis}
		\begin{wrapfigure}{r}{0.4\textwidth}
			\center{\includegraphics[width=0.3\textwidth]{flächenfunktion.png}}
		\end{wrapfigure}
...
\subsection{Fläche zwischen zwei Graphen}
	...
	\begin{aufgabe}
		...
		\begin{enumerate}[label=\alph*)]
			...
			\item Wir definieren die Differenzfunktion $f(x)-g(x)$. Welche Fläche wird nun von dieser Differenzfunktion und der $x-$Achse eingeschlossen?\vspace{5pt}\newline\karos{1}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{13mm}|p{20mm}|p{30mm}|p{70mm}|}\hline
		...
		to Do & 03.12.25 & Jonas Guler & Aufgabe 5.6 Funktionen anpassen\newline b) Nullstelle ausserhalb Intervall\newline c) Fläche unendlich \\\hline
	\end{tabular}
\end{table}
