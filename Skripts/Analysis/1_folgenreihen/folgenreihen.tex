...
\section{Einführung}
	\begin{aufgabe}
		...
		\begin{enumcols}[2]
			\item $3,9,5,15,11,33,\ldots$\vspace*{11pt}\newline
			\item $1,2,4,7,11,16,\ldots$\vspace*{11pt}\newline
			\item $15,9,27,20,60,52,\ldots$\vspace*{11pt}\newline
			\item $2,6,18,54,162,486,\ldots$\vspace*{11pt}\newline
		\end{enumcols}
	...
	\begin{aufgabe}
		Eine Person muss heute früh ein einziges Mal eine Tablette einnehmen. Dabei wird dem Körper $100$mg eines Wirkstoffes zugeführt, wobei dieser innerhalb von $24$ Stunden zu $60\%$ vom Körper wieder abgebaut wird. Wir bezeichnen mit $a_n$ die Wirkstoffmenge in mg im Körper am Tag $n$ nach Beginn der Einnahme.\newline
		Am Tag $1$ werden dem Körper also $100$mg zugeführt: $a_1=100$. (Auf die Einheit wird bewusst verzichtet, da es immer die gleiche ist.) Am zweiten Tag sind vom Körper $60\%$ der ersten Dosis abgebaut, das bedeutet: $a_2=0.4\*100=40.$
...
\section{Folgen}
	...
	\begin{minipage}{0.5\linewidth}
		\[a:y=5-x,\qquad x\in\left\{1,2,3,\ldots\right\}\]
		\begingroup
...
\subsection{Summen- und Produktzeichen}
	...
	\begin{aufgabe}
		...
		\begin{enumerate}\setcounter{enumi}{1}
			\item Von der Reihe $(s_n)$ einer Folge $(a_n)$ weiss man, dass $s_1=5$, $s_2=7$ und $s_3=38$. Wie viele und welche Glieder der Folge können wir daraus rekonstruieren?
		\end{enumerate}\karos{3.5}
...
\subsection{Arithmetische Folgen und Reihen}
	...
	\begin{definition}[arithmetische Reihe]
		Die zu einer arithmetischen Folge gehörende Partialsummenfolge $s_n$ mit \[s_n=a_1+a_2+\ldots+a_n=\sum_{i=1}^n a_i\] heisst \textbf{arithmetische Reihe}.
	\end{definition}
	Für die Partialsumme einer arithmetischen Reihe ergibt sich:\vspace{5pt}\newline\karos{7}
	\begin{satz}
		Ist $\left(a_n\right)_{n\in\N}$ eine arithmetische Folge mit Differenz $d$, dann gilt für die Partialsumme der arithmetischen Reihe: \[s_n=\hspace*{11cm}\]
	\end{satz}
	\begin{aufgabe}
		\begin{enumerate}
...
\subsection{Geometrische Folgen und Reihen}
	...
	\begin{table}[H]
		\vspace{24pt}
		\centering
		\begin{tabular}{c|p{8mm}|p{8mm}|p{8mm}|p{8mm}|p{8mm}|p{10mm}|p{10mm}|p{15mm}|p{15mm}}
			$n$ & 1 & 2 & 3 & 4 & 5 & 6 & 10 & 20 & 100\\\hline
			$a_n$ & & & & & & & & &
		\end{tabular}
		\vspace{24pt}
	...
	\begin{satz}
		Das allgemeine Glied $a_n$ einer geometrischen Folge ist gegeben durch: \[a_n=\hspace*{11cm}\]
	\end{satz}\newpage
	\begin{beispiel}
	...
	\begin{definition}[geometrische Reihe]
		Die zu einer geometrischen Folge gehörende Partialsummenfolge $s_n$ mit \[s_n=a_1+a_2+\ldots+a_n=\sum_{i=1}^n a_i\] heisst \textbf{geometrische Reihe}.
	\end{definition}
	Für die Partialsumme einer geometrischen Reihe ergibt sich:\vspace{5pt}\newline\karos{5}\newline\karos{5}
	\begin{satz}
		Ist $\left(a_n\right)_{n\in\N}$ eine geometrische Folge mit Quotient $q$, dann gilt für die Partialsumme der geometrische Reihe: \[a_n=\hspace*{11cm}\]
	\end{satz}
	\begin{aufgabe}
		\begin{enumerate}
	...
	\begin{aufgabe}[gemischte Aufgaben]
		\begin{enumerate}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{sierpinski.png}
			\end{figure}
			\begin{enumerate}[label=\alph*)]
...
\section{Unendliche geometrische Folgen und Reihen}
	...
	\begin{beispiel}\ \\
		\begin{minipage}{0.35\linewidth}
			...
			\begin{table}[H]
				\centering
				\begin{tabular}{c|p{7mm}|p{7mm}|p{7mm}|p{7mm}|p{7mm}}
					$n$ & $1$ & $2$ & $3$ & $4$ & $5$ \\\hline
					$a_n$ & & & & &
				\end{tabular}
			\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{13mm}|p{20mm}|p{30mm}|p{70mm}|}\hline
		...
		$0.1$ & 02.08.24 & Jonas Guler & Kapitel erstellt \\\hline
		$1.0$ & 01.04.25 & Jonas Guler & Kapitel fertig \\\hline
		$1.1$ & 29.09.25 & Jonas Guler & Fehler überarbeitet \\\hline
		$1.2$ & 19.11.25 & Jonas Guler & Fehler überarbeitet \\\hline
	\end{tabular}
\end{table}
