...
\section{Definition des Logarithmus}
	...
	\end{beispiel}
	\begin{aufgabe}
		Schreibe die Exponentialgleichung in logarithmischer Form, die Logaritmusgleichungen in exponetieller Form und löse die Gleichungen auf drei Nachkommastellen genau.
		\begin{enumcols}[3]
	...
	\end{aufgabe}
	\begin{aufgabe}
		Löse die Aufgaben $1-4$ auf Seite 183 im Buuch Algebra $9/10$
	\end{aufgabe}
	Wir sind nun also in der Lage, auch schwierigere Exponentialgleichungen zu lösen.
	\begin{aufgabe}
		Löse die folgenden Exponantialgleichungen und überprüfe deine Lösung mit dem Taschenrechner.
		\begin{enumcols}[2]
...
\section{Rechenregeln}
	...
	\begin{aufgabe}
		...
		\begin{enumcols}[4]
				\item $\log_{12}(144)$ \item $\log_{10}(0.001)$
	...
	\end{aufgabe}
	\begin{aufgabe}
		Löse die Aufgaben $32-43$ auf Seite $187$ im Buch Algebra $9/10$.
	\end{aufgabe}
	\begin{aufgabe}
...
\section{Der Basiswechselsatz}
	...
	\end{satz}
	\begin{aufgabe}
		Berechne die folgenden Logarithmen ausschliesslich mit dem Handy-Taschenrechner.
		\begin{enumcols}[3]
		...
		\end{enumcols}
		Löse anschliessend die Aufgaben $53-55$ und $58$ auf Seite $189$ im Algebra $9/10$.
	\end{aufgabe}
	...
	\[x=\Log{a}{b}=\frac{\log(b)}{\log(a)}=\frac{\ln(b)}{\ln(a)}\]
	\begin{aufgabe}
		Löse die Aufgaben $65-69$ auf Seite $190$ im Algebra $9/10$.
	\end{aufgabe}\newpage
	\subsection*{Vergleich von Zahlen}
	In der folgenden Aufgabe sind zwei Potenzen gegeben, die für unseren einfachen Handy-Taschen- rechner leider nicht möglich sind zu berechnen. Also können wir auch nicht einen direkten Vergleich anstellen. Notiere dir hier deinen Tipp.
	\begin{aufgabe}
...
\section{Die Logarithmusfunktion}
	...
	\begin{beispiel}
		...
		\end{minipage}
	\end{beispiel}
	\begin{satz}[Wachtumsverhalten]
		Eine Funktion der Form $h(x)=\Log{a}{x}$ zeigt folgendes Wachtumsverhalten in Abhängigkeit der Basis $a$:
		\begin{itemize}
			\item \rule{10cm}{1pt}
			\item \rule{10cm}{1pt}
		\end{itemize}
	...
	\begin{aufgabe}
		\begin{enumerate}[label=\alph*)]
			\item Löse die Aufgaben $22-24$ und $27$ auf Seite $185$ im Algebra $9/10$.\vspace{6pt}
			\item\begin{minipage}{0.57\linewidth}
			...
			\begin{minipage}{0.4\linewidth}
				\centering\includegraphics[scale=0.15]{images/shiftedLog1.png}
			\end{minipage}
			\item Beschreibe danach den Einfluss der beiden verschiedenen Parameter $b$ und $c$ der allgemeinen Funktion \[f(x)=\Log{a}{x-b}+c.\] Vergleiche dazu das \href{https://www.geogebra.org/m/qungkacj}{Geogebra-Applet}.
			\item Löse zum Schluss die Aufgabe $28$ auf Seite $186$ im Algebra $9/10$.
		\end{enumerate}
	\end{aufgabe}
...
\subsection{Lautstärke}
	\begin{figure}[ht]
		...
		\includegraphics[scale=0.75]{images/Schreihals.png}
	\end{figure}
	\begin{wrapfigure}{r}{0.3\textwidth}
		\center{\includegraphics[scale=0.75]{images/SoundIntensity.png}}
	\end{wrapfigure}
	...
	\begin{minipage}{0.3\linewidth}
		\centering\includegraphics[scale=0.4]{images/DezibelSkala.png}
	\end{minipage}
	\hfill
	\begin{minipage}{0.3\linewidth}
		\centering\includegraphics[scale=0.4]{images/DezibelGraph.png}
	\end{minipage}
	\hfill
	\begin{minipage}{0.3\linewidth}
		\centering\includegraphics[scale=0.6]{images/ExposureTime.png}
	\end{minipage}
	...
	\begin{aufgabe}
		...
		\end{enumerate}
		Abgabe: Ende der Doppellektion per \href{mailto://jonas.guler@ksh.edu}{Mail} an jonas.guler@ksh.edu. Die besten Arbeiten pro Anwendung werde ich euch in der Inhaltsbibliothek zur Verfügung stellen.
	\end{aufgabe}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{13mm}|p{20mm}|p{30mm}|p{70mm}|}\hline
		...
		$0.2$ & ToDo & Jonas Guler & Anwendungen ergänzen \\\hline
	\end{tabular}
\end{table}
