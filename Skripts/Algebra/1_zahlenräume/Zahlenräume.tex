...
\section{Die Menge}
    ...
    \begin{notation}
    	\begin{enumerate}[label=\ ]
    		\item {\bf Aufzählende Form:} Die aufzählende Form haben wir oben im Beispiel \ref{bsp:aufzählmengen} resp. in der Aufgabe \thesection.\ref{aufg:aufzählmengen} bereits gesehen. Dabei werden die einzelnen Elemente der Menge zwischen geschweiften Klammern notiert. Ein weiteres Beispiel wäre: \[A=\left\{Mo, Di, Mi, Do, Fr, Sa, So\right\};\quad B=\left\{1,2,3,6\right\}\]
    		\item {\bf Beschreibende Form:} In der beschreibenden Form werden die einzelnen Elemente in deutscher Sprache beschrieben. \[A=\text{Menge aller Wochentage};\quad B=\text{Menge aller Teiler von $6$}\]
...
\subsection{Teilmenge}
    ...
    \begin{aufgabe}
    	\begin{enumerate}
    		...
    		\end{enumcols}
    		\item Notiere jeweils alle möglichen Teilmengen von $A=\left\{0,1\right\}, B=\left\{0,1,2\right\}$ und $C=\left\{0,1,2,3\right\}$. Was stellt du bezüglich der Anzahl Teilmengen fest?
