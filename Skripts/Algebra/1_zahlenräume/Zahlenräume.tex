...
\subsection{Teilmenge}
    ...
    \begin{beispiel}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.8]{Algebra/1_menge/images/teilmenge.png}
        \end{figure}
...
\subsection{Mengenoperationen}
    ...
    \begin{enumerate}[label=\ ]
            ...
            \begin{minipage}{0.37\linewidth}
                \centering
                \includegraphics[scale=0.7]{Algebra/1_menge/images/operationen.png}
...
\subsection{Intervalle}
    ...
    \begin{definition}[Intervall]
        ...
        \begin{enumerate}[label=\alph*)]
            ...
            \hfill
            \begin{minipage}{0.37\linewidth}
                \centering\includegraphics[scale=1]{Algebra/1_menge/images/geschlossen.png}
            \end{minipage}
            ...
            \hfill
            \begin{minipage}{0.37\linewidth}
                \centering\includegraphics[scale=1]{Algebra/1_menge/images/offen.png}
            \end{minipage}
            ...
            \hfill
            \begin{minipage}{0.37\linewidth}
                \centering\includegraphics[scale=1]{Algebra/1_menge/images/halboffenlinks.png}
            \end{minipage}
            ...
            \hfill
            \begin{minipage}{0.37\linewidth}
                \centering\includegraphics[scale=1]{Algebra/1_menge/images/halboffenrechts.png}
            \end{minipage}
        \end{enumerate}
    \end{definition}
