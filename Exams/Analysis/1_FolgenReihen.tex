...
%---------------------------------------------------------
\question[6] %DMK Ana S28 A167
Begründe, ob es sich bei den Folgen um eine arithmetische, geometrische oder weder noch handelt?
\begin{parts} %e
    \part $1,2,4,8,15,\ldots$ %e
    \part $765, 654, 543, 432, 321,\ldots$ %c
    \part $2, -6, 18, -54, 162, -486,\ldots$ %h
\end{parts}
...
\begin{minipage}{0.35\linewidth}
    \centering\includegraphics[scale=0.6]{data-analysis/FR_Quadrate.png}
\end{minipage}
\begin{parts}
...
\begin{minipage}{0.37\linewidth}
    \centering\includegraphics[scale=0.25]{data-analysis/FR_pendel.jpeg}
\end{minipage}
\begin{parts}
...
\begin{minipage}{0.25\linewidth}
    \centering\includegraphics[scale=0.4]{data-analysis/FR_kreisquadrat.png}
\end{minipage}
