...
\begin{parts}
	...
	\part[2] Finde die Gleichung der Tangente an den Graphen von $f$ im Punkt $P(0\;\vert\; y)$.
	\part[2] Unter welchem spitzen Winkel schneidet die Tangente die $y-$Achse?
	\part[2] Finde die Gleichung der Normale an den Funktionsgraphen im Punkt $Q(3\;\vert\; y)$.
\end{parts}
