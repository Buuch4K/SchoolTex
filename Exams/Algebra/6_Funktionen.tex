...
\begin{parts}
    ...
    \begin{minipage}{0.2\linewidth}
        \centering\includegraphics[scale=1]{data-algebra/Fkt1.png}
    \end{minipage}
    \hfill
    ...
    \vspace{1cm}\part
    \begin{minipage}{0.2\linewidth}
        \centering\includegraphics[scale=1]{data-algebra/Fkt2.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.7\linewidth}
        \antwort{6}
    ...
    \vspace{1cm}\part
    \begin{minipage}{0.2\linewidth}
        \centering\includegraphics[scale=0.75]{data-algebra/Fkt3.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.7\linewidth}
        \antwort{6}
    ...
    \vspace{1cm}\part
    \begin{minipage}{0.2\linewidth}
        \centering\includegraphics[scale=1]{data-algebra/Fkt4.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.7\linewidth}
        \antwort{6}
    ...
    \vspace{1cm}\part
    \begin{minipage}{0.2\linewidth}
        \centering\includegraphics[scale=1]{data-algebra/Fkt5.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.7\linewidth}
        \antwort{6}
    ...
    \part
    \begin{minipage}{0.2\linewidth}
    	\centering\includegraphics[scale=0.38]{Algebra/data-algebra/Fkt6.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.7\linewidth}
    	\antwort{6}
...
\begin{parts}
    ...
    \part Berechne die folgenden Funktionswerte: $f(2)$, $f(-1)$ und $f(m)$.
...
\begin{parts}
    ...
    \part Berechne die folgenden Funktionswerte: $f(3)$, $f(-2)$ und $f(m-2)$.
...
\hfill
\begin{minipage}{0.45\linewidth}
    \centering\includegraphics[scale=0.65]{data-algebra/GraphGaMa.png}
\end{minipage}
...
\begin{table}[H]
	\centering
	\begin{tabular}{|c|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|p{1cm}|}\hline
		{\bf x} & -2 & -1 & 0 & 1 & 2 & 3 & 4 & 5 \\\hline
		{\bf y} & & & & & & & & \\\hline
	\end{tabular}
\end{table}
\endgroup
