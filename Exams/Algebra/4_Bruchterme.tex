...
%--------------------- MULTIPLICATION ------------------------------------
\question[6]
Multipliziere die Brüche und vereinfache dann den Term so weit wie möglich.
\begin{parts}
...
\begin{parts}
	\part $\frac{4x^2-12x+9}{9x^2+6x+1}\div\frac{2ax-3a}{6x+2}$ %KSWillisau A4d
...
\question[4]
Vereinfache den folgenden Ausdruck so weit wie möglich.
\[\frac{\frac{(x+3y)^2}{6xy}}{\frac{6y+2x}{xy}}=\hspace{10cm}\] %KSWillisau A4e
...
Vereinfache die Terme so weit wie möglich.
\begin{parts}
    \part $\frac{4bd}{c}\*\left(\frac{3a}{4b}+\frac{15c}{6d}\right)$ %KSWillisau A5a
    \part $\frac{\frac{x+h}{x+h-1}-\frac{x}{x-1}}{h}$ % DMK910 S34 A10d
    \part $\left(\frac{8x^2+4x+1}{4x^2-2x}-\frac{2x}{2x-1}\right)\*\frac{6x-3}{4x^2+2x}$ %DMK910 S34 A8b
\end{parts}
