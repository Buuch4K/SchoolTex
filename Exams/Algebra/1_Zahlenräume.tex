...
\begin{minipage}[t]{0.45\linewidth}
	\centering\includegraphics[width=5cm]{a).png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.45\linewidth}
	\centering\includegraphics[width=5cm]{c).png}
\end{minipage}
\begin{parts}
	\part[2] Schreibe die grau markierte Mengen als Mengenterm.
\end{parts}
\begin{minipage}{0.45\linewidth}
	\centering\includegraphics[width=5cm]{f).png}
\end{minipage}
\hfill
\begin{minipage}{0.45\linewidth}
	\centering\includegraphics[width=5cm]{b).png}
\end{minipage}
\begin{parts}
	\part[2] Schreibe die grau markierte Mengen als Mengenterm.
\end{parts}
