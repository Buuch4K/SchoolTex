...
\begin{parts}
    ...
    \[\Log{4}{2}\quad\Log{7}{49}\quad\Log{2}{8}\quad\Log{3}{81}\]
\end{parts}

\begin{parts}
    \setcounter{partno}{4}
    \part[4] Löse die folgende Exponantialgleichung ohne Verwendung des Taschenrechners nach $x$ auf.
...
\begin{parts}
    \setcounter{partno}{5}
    \part[4] Löse die folgende Exponantialgleichung ohne Verwendung von \flqq solve\frqq\: nach $x$ auf. \[5^{x+2}\*125^{2-x}=25^x\]
    \begin{small}
        Bewertung: Lösungen ohne Lösungsweg ergeben keine Punkte.
    \end{small}
\end{parts}
...
\begin{minipage}{0.35\linewidth}
    \centering\includegraphics[scale=0.1]{data-algebra/LogGraphen2.png}
\end{minipage}
...
\hfill
\begin{minipage}{0.35\linewidth}
    \centering\includegraphics[scale=0.08]{data-algebra/LogGraph.png}
\end{minipage}
...
\begin{minipage}{0.4\linewidth}
    \centering\includegraphics[scale=0.1]{data-algebra/LogGraph.png}
\end{minipage}
