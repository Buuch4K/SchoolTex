...
\begin{minipage}{0.45\linewidth}
    \centering\includegraphics[scale=3]{data-algebra/expGraph.png}
\end{minipage}
\hfill
\begin{minipage}{0.45\linewidth}
    \begin{parts}
...
\question[8] %NeueWege
\begin{parts}
    \part Im Jahr $1950$ lebten $2.5$ Milliarden Menschen auf der Erde, $1980$ waren es dann $4.5$ Milliarden. Modelliere das Bevölkerungswachstum und bestimme die Verdoppelungszeit.
    \part Vergleiche dein Resultat mit den Daten von $2005$ ($6.4$ Milliarden) und $1920$ ($1.8$ Milliarden). Was fällt dir auf?
    \part $2005$ prognostizierten Experten der Vereinten Nationen bis zum Jahr $2050$ einen Anstieg auf $9.1$ Milliarden. Wie lautet deine Prognose?
\end{parts}
