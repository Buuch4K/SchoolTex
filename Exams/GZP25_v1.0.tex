...
\ifthenelse{\boolean{printanswers}}
{\begin{solution}
	\[\frac{x\*x^4\left(y^{-2}\*\sqrt{y^{16}}\right)}{x^{-2}\*x^7\*\sqrt{x^4}}=x^5\*y^{-2}\*y^3\*x^{-5}\*x^{-1}=y^1\*x^{-1}=\frac{y}{x}\]
\end{solution}}
...
\hfill
\begin{minipage}{0.3\linewidth}
	\centering\includegraphics[scale=0.4]{Geometrie/data-geometrie/GZP25_Teil2Aufg6.png}
\end{minipage}
\ifthenelse{\boolean{printanswers}}
{\begin{solution}
