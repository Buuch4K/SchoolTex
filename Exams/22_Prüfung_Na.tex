...
\begin{center}
    ...
    \textbf{Beachte: In den Aufgaben 6, 7a und 8 gibt es für Lösungen ohne Lösungswege keine Punkte!}
\end{center}
...
\begin{minipage}{0.35\linewidth}
	\centering\includegraphics[scale=0.6]{Analysis/data-analysis/FR_Quadrate.png}
\end{minipage}
\begin{parts}
