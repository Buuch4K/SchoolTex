...
\begin{center}
    ...
    {\bf Beachte:} In den Aufgaben 3b, 6c und 8 werden Lösungswege mit Hilfe der CAS-Funktionen des Taschenrechners nicht bewertet.
\end{center}
\rule[1ex]{\textwidth}{1pt}
...
\begin{parts}
\setcounter{partno}{2}
	\part[3] Berechne den Differentialquotient an der Stelle $x_0=3$. Was sagt dieser Wert aus?
\end{parts}
...
\newpage
\question[6]
Skizziere ins leere Koordinatensystem den Graphen der Ableitungsfunktion der gegebenen Funktion $f$ möglichst exakt. Markiere in deiner Skizze zusätzlich folgende Stellen und Bereiche:
\begin{parts}
	\part Stellen mit Steigung Null,
	\part Bereiche mit positiver, resp. negativer Steigung und
	\part Stellen mit grösster Steigung.
\end{parts}
\begin{figure}[H]
	\centering
