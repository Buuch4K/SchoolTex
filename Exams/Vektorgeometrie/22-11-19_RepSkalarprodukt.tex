...
%=========================================================
\newcommand{\thema}{Repetition Vektorgeometrie \uproman{2}}
...
\newpage
\question[4]
Welche Koordinaten hat der Schwerpunkt $S$ des Dreiecks $ABC$
...
\question[3]
\begin{parts}
\part Berechne das Skalarprodukt $\Vec{a}\cdot\Vec{b}$, wenn gilt $\lvert\Vec{a}\rvert=6,\lvert\Vec{b}\rvert=4$ und $\alpha=30^\circ$.
\end{parts}
\vspace{5pt}
\antwort{4}
\begin{parts}
\setcounter{partno}{1}
\part Berechne den Zwischenwinkel von $\Vec{a}$ und $\Vec{b}$, wenn gilt $\Vec{a}\cdot\Vec{b}=20$, $\lvert\Vec{a}\rvert=2\cdot\sqrt{2}$ und $\lvert\Vec{b}\rvert=5$.
\end{parts}
\vspace{5pt}
\antwort{4}
\begin{parts}
