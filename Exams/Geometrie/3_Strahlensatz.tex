...
\begin{minipage}{0.35\linewidth}
    \centering\includegraphics[scale=1]{data-geometrie/strahlensatzfigurkomplex.png}
\end{minipage}
\hfill
...
\begin{figure}[H]
    \centering\includegraphics[scale=0.8]{data-geometrie/strahlensatz2.png}
\end{figure}
...
\begin{figure}[H]
	\centering\includegraphics[width=0.5\linewidth]{strahlensatz4.png}
\end{figure}
...
\begin{figure}[H]
    \centering\includegraphics[scale=0.1]{flugzeughangar.png}
\end{figure}
...
\begin{minipage}{0.4\linewidth}
    \centering\includegraphics[scale=0.8]{ähnlicheDreiecke.jpg}
\end{minipage}
...
\hfill
\begin{minipage}{0.35\linewidth}
    \centering\includegraphics[scale=0.8]{RechteckeMitÄhnlichkeit.png}
\end{minipage}
...
\begin{minipage}{0.3\linewidth}
    \centering\includegraphics[scale=0.5]{doppelterstrahlensatz.png}
\end{minipage}
