...
\begin{figure}[H]
    \centering\includegraphics[width=0.5\linewidth]{data-geometrie/parallelität_wahr.png}
\end{figure}
...
Begründe mit Hilfe der Strahlensätze, ob alle drei, nur zwei oder keine der Geraden $a,b,c$ parallel sind.
\begin{figure}[H]
    \centering\includegraphics[width=0.5\linewidth]{data-geometrie/parallelität_falsch.jpeg}
\end{figure}
...
\begin{figure}[H]
    \centering\includegraphics[scale=0.1]{data-geometrie/flugzeughangar.png}
\end{figure}
...
\begin{minipage}{0.4\linewidth}
    \centering\includegraphics[scale=0.8]{data-geometrie/ähnlicheDreiecke.jpg}
\end{minipage}
...
\hfill
\begin{minipage}{0.35\linewidth}
    \centering\includegraphics[scale=0.8]{data-geometrie/RechteckeMitÄhnlichkein.png}
\end{minipage}
...
\begin{minipage}{0.3\linewidth}
    \centering\includegraphics[scale=0.5]{data-geometrie/doppelterstralelnsatz.png}
\end{minipage}
...
\begin{figure}[H]
    \centering\includegraphics[scale=0.8]{data-geometrie/rechteckstrahelnsatz.png}
\end{figure}
...
\hfill
\begin{minipage}{0.35\linewidth}
    \centering\includegraphics[scale=0.4]{data-geometrie/ähnlicheflächen.png}
\end{minipage}
\vspace{5pt}
