...
%---------------------------------------------------------
	...
	\begin{parts}
		\part[1] Stelle den zeitlichen Verlauf der Konzeptration im Blut graphisch dar, wenn unsere Versuchsperson genau eine solche Tablette pro Tag nimmt.
		\part[1] Wie viele Stunden wirkt eine einzige Tablette?
		\part[2] Nehmen wir an, bei einer Tablette Aspririn mit doppelter Menge Wirkstoff wird die Halbwertszeit der Wirkstoffkonzentration im Blut vervierfacht und es reicht einen Viertel der Initialkonzentration damit sie schmerzlindernd wirkt. Kann diese Tablette einen gesamten Arbeitstag ($8$ Stunden) schmerzlindernd wirken?
	\end{parts}
...
\section{Folgen und Reihen (ohne TR)}
	...
	\begin{figure}[H]
		\centering\includegraphics[scale=0.65]{zahlenpyramide.png}
	\end{figure}
	\begin{parts}
...
\section{Folgen und Reihen (mit TR)}
	...
	\end{parts}
	\begin{figure}[H]
		\centering\includegraphics[scale=0.8]{unendliche-brücken.png}
	\end{figure}
...
%---------------------------------------------------------
	...
	\end{parts}
	\begin{figure}[H]
		\centering\includegraphics[scale=0.8]{verschachtelte-dreiecke.png}
	\end{figure}
